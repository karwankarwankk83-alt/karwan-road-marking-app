(()=>{
  ...
  const css=`
  .ks-ai-btn{flex:0 0 44px;width:44px;height:44px;border-radius:13px;border:1px solid #806600;background:#f4c400;color:#111;font-size:20px;box-shadow:none;cursor:pointer;display:grid;place-items:center}.ks-ai-btn:hover,.ks-ai-btn:focus-visible{filter:brightness(1.08);transform:translateY(-1px)}
  ...
  (document.querySelector('.topbar')||document.body).appendChild(btn);document.body.appendChild(panel);
