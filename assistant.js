(()=>{
  ...
  const css=`
  .ks-ai-btn{position:fixed;left:18px;right:auto;bottom:104px;z-index:90;width:58px;height:58px;border-radius:50%;border:2px solid #806600;background:#f4c400;color:#111;font-size:25px;box-shadow:0 12px 35px #0009;cursor:pointer}
