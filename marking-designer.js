...
const templates={
 ...
 disabled:{name:'شوێنی خاوەن پێداویستی تایبەت',kind:'disabled',w:1.5,h:2,note:'هێمای 623.4؛ قەبارەی گشتی 1.50 × 2.00 m. گریدی 10 cm بۆ زەرعکردنی ورد.'},
...
function drawing(t,w,h){
 ...
 else if(t.kind==='disabled'){
  body='<g fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round"><circle cx="169" cy="67" r="15" fill="#fff" stroke="none"/><path d="M151 91l31 25-18 24h42" stroke-width="18"/><path d="M151 94l-25 27" stroke-width="16"/><path d="M170 141l31 49" stroke-width="17"/><path d="M166 143l-23 23" stroke-width="16"/><circle cx="126" cy="176" r="45" stroke-width="13"/><path d="M158 207l22 22" stroke-width="13"/></g>';
  shapeDims='<g stroke="#58d68d" stroke-width="1.35" fill="none"><path d="M154 43h30M154 39v8M184 39v8"/><path d="M72 131v90M68 131h8M68 221h8"/><path d="M84 228h84M84 224v8M168 224v8"/><path d="M116 113l30-34M112 109l8 7M142 75l8 7"/><path d="M184 126h36M184 122v8M220 122v8"/><path d="M185 147l28 44M181 149l8-5M209 193l8-5"/></g><g fill="#58d68d" font-size="7.2" font-family="Arial" direction="ltr" unicode-bidi="bidi-override"><text x="169" y="36" text-anchor="middle">20 cm</text><text x="63" y="176" text-anchor="middle" transform="rotate(-90 63 176)">75 cm</text><text x="126" y="241" text-anchor="middle">70 cm</text><text x="122" y="91" text-anchor="middle" transform="rotate(-49 122 91)">45 cm</text><text x="202" y="118" text-anchor="middle">30 cm</text><text x="207" y="168" text-anchor="middle" transform="rotate(58 207 168)">55 cm</text><text x="150" y="258" text-anchor="middle">10 cm × 10 cm</text></g>';
 }
 ...
 let universalGrid='';if(t.kind!=='text'){const cell=t.kind==='disabled'?.1:.2,cols=Math.max(1,Math.round(w/cell)),rows=Math.max(1,Math.round(h/cell)),gx=230/cols,gy=210/rows;for(let i=0;i<=cols;i++)universalGrid+=`<path d="M${35+i*gx} 30V240"/>`;for(let i=0;i<=rows;i++)universalGrid+=`<path d="M35 ${30+i*gy}H265"/>`}
