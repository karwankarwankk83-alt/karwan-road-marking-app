...
const SURFACE_COVERAGE_FACTORS={
  smoothAsphalt:{ku:'قیری نوێ و ساف',en:'Smooth Asphalt',factor:1.00},
  roughAsphalt:{ku:'قیری کۆن / زبر',en:'Rough Asphalt',factor:1.10},
